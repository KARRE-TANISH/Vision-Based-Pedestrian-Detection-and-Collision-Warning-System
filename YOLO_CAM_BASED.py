...
while True:
    ...
    if warning:
        cv2.putText(frame,"STOP! PEDESTRIAN AHEAD",(50, 50),cv2.FONT_HERSHEY_SIMPLEX,1,(0, 0, 255),3)

        if current_time - last_beep_time > beep_interval:
            winsound.Beep(1200, 200)  
            last_beep_time = current_time

    cv2.imshow("Vision-Based Pedestrian Detection and Collision Warning System", frame)
